...
import { November as NovemberPie } from './components/PieChart';
import MonthRecords from './components/MonthRecords';
import { NovemberCategories } from './components/MonthChart';
import { NovemberTable } from './components/DataTable';
        ...
        <div className="App">
          <div className="Body">
                <ButtonGroup variant='contained' color='primary' style={{marginTop: '20px'}}>
                        ...
                        title = 'Add Income'>
                            <RecordForm type='income' month='November' />
                        </Popup>
                    <Button onClick={() => setIncomePopup(true)} startIcon={<AddIcon />}>Add Income</Button>
                        ...
                        title = 'Add Expense'>
                            <RecordForm type='expense' month='November' />
                        </Popup>
                                ...
                                <div className='align-vertically'>
                                    ...
                                    <div className='width100' style={{marginTop: '10px'}}>
                                        <Grid container>
                                            ...
                                            <Grid item xs={3}>
                                                <MonthRecords month='November' type='income' />
                                            </Grid>
                                            <Grid item xs={3}></Grid>
                                        </Grid>
                                    </div>
                                    ...
                                    <div className='width100'>
                                        <Grid container>
                                            ...
                                            <Grid item xs={3}>
                                                <MonthRecords month='November' type='expenses' />
                                            </Grid>
                                            <Grid item xs={3}></Grid>
                                        </Grid>
                                    </div>
                                    ...
                                    <div className='width100' style={{marginBottom: '10px'}}>
                                        <Grid container>
                                            ...
                                            <Grid item xs={3}>
                                                <MonthRecords month='November' type='balance' />
                                            </Grid>
                                            <Grid item xs={3}></Grid>
                                        </Grid>
                                    </div>
